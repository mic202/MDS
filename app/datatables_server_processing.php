...
require_once('../admin/connect.ini.php');
	 ...
	 */
	$aColumns = array( 'id','maker', 'oe_num', 'oe_num_short', 'mic_num', 'model', 'model_year', 'part_desc', 'part_name', 'part_code', 'part_group', 'part_cube', 'hs_code_us', 'oe_price_us', 'oe_price_ca');
